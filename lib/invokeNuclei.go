...
func ReadNucleiConfig(flagSet *goflags.FlagSet) *types.Options {
	_ = readConfig(flagSet)
...
func readConfig(flagSet *goflags.FlagSet) *goflags.FlagSet {

	// when true updates nuclei binary to latest version
	//var updateNucleiBinary bool
	var pdcpauth bool

	flagSet.CreateGroup("input", "Nuclei Target",
	...
	flagSet.CreateGroup("templates", "Nuclei Templates",
	...
	flagSet.CreateGroup("filters", "Nuclei Filtering",
	...
	flagSet.CreateGroup("output", "Nuclei Output",
	...
	flagSet.CreateGroup("configs", "Nuclei Configurations",
		...
		flagSet.StringVar(&options.Interface, "interface", "", "network interface to use for network scan"),
	...
	flagSet.CreateGroup("interactsh", "Nuclei interactsh",
	...
	flagSet.CreateGroup("fuzzing", "Nuclei Fuzzing",
	...
	flagSet.CreateGroup("uncover", "Nuclei Uncover",
	...
	flagSet.CreateGroup("rate-limit", "Nuclei Rate-Limit",
	...
	flagSet.CreateGroup("optimization", "Nuclei Optimizations",
	...
	flagSet.CreateGroup("headless", "Nuclei Headless",
	...
	flagSet.CreateGroup("debug", "Nuclei Debug",
	...
	flagSet.CreateGroup("update", "Nuclei Update",
	...
	flagSet.CreateGroup("stats", "Nuclei Statistics",
	...
	flagSet.CreateGroup("cloud", "Nuclei Cloud",
